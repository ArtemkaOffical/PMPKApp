...
namespace PMPK
{
    public partial class EdProgramForm : Form, IForm
    {
        private UnitOfWork _unitOfWork;

        public EdProgramForm()
        {
            InitializeComponent();
        ...
        {
            _unitOfWork.Save();
            DataTable data = _unitOfWork.AProgramsRepository.Get().ToList().ConvertToDataTable();
        ...
        {
            _unitOfWork.AProgramsRepository.Insert(new AdaptiveProgram());
        ...
        public void Save()
        {
            for (int i = 0; i < dataGridView1.Rows.Count - 1; i++)
            {
                AdaptiveProgram currentClass = _unitOfWork.AProgramsRepository.GetByID(Convert.ToInt32(dataGridView1["Id", dataGridView1.Rows[i].Index].Value));
        ...
        public void Delete()
        {
            if (dataGridView1.CurrentRow != null)
            {
                ...
                {
                    _unitOfWork.AProgramsRepository.Delete(Convert.ToInt32(dataGridView1["Id", dataGridView1.CurrentRow.Index].Value));
                    UpdateDataGridView();
                }
            }
        }
        ...
        private void EdProgramForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            this.Dispose();
        }
    }
