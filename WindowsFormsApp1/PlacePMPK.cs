...
namespace PMPK
{
    public partial class PlacePMPK : Form, IForm
    {
        ...
        {
            _unitOfWork.Save();
            DataTable data = _unitOfWork.PlaceOfPMPKsRepository.Get().ToList().ConvertToDataTable();
        ...
        {
            _unitOfWork.PlaceOfPMPKsRepository.Insert(new PlaceOfPMPK());
        ...
        public void Save()
        {
            for (int i = 0; i < dataGridView1.Rows.Count - 1; i++)
            {
                PlaceOfPMPK currentClass = _unitOfWork.PlaceOfPMPKsRepository.GetByID(Convert.ToInt32(dataGridView1["Id", dataGridView1.Rows[i].Index].Value));
        ...
        public void Delete()
        {
            if (dataGridView1.CurrentRow != null)
            {
                ...
                {
                    _unitOfWork.PlaceOfPMPKsRepository.Delete(Convert.ToInt32(dataGridView1["Id", dataGridView1.CurrentRow.Index].Value));
                    UpdateDataGridView();
                }
            }
        }
        ...
        private void PlacePMPK_FormClosing(object sender, FormClosingEventArgs e)
        {
            this.Dispose();
        }
    }
