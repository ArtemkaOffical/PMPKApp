...
namespace PMPK
{
    public partial class EdOrgForm : Form, IForm
    {
        ...
        {
            _unitOfWork.EdOrgsRepository.Insert(new EdOrg());
        ...
        public void Save()
        {
            for (int i = 0; i < dataGridView1.Rows.Count - 1; i++)
            {
                EdOrg currentClass = _unitOfWork.EdOrgsRepository.GetByID(Convert.ToInt32(dataGridView1["Id", dataGridView1.Rows[i].Index].Value));
        ...
        public void Delete()
        {
            if (dataGridView1.CurrentRow != null)
            {
                ...
                {
                    _unitOfWork.EdOrgsRepository.Delete(Convert.ToInt32(dataGridView1["Id", dataGridView1.CurrentRow.Index].Value));
                    UpdateDataGridView();
                }
            }
        }
        ...
        private void EdOrgForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            this.Dispose();
        }
    }
